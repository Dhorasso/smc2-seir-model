...
# The epi_model.py file contain others example of SEIR models
#############################################################################################
...
def stochastic_seair_model(y, theta, theta_names, dt=1):
    ...
    # Simulate transitions using binomial drawsdef stochastic_seair_model(y, theta, theta_names, dt=1):
    """
    Vectorized discrete-time stochastic SEAIR compartmental model.
