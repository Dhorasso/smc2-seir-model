...
This framework supports both offline and online SMC^2 applications for parameter and state estimation in dynamic systems. Link to the paper on arXiv [Link to the paper on arXiv](
